...
For this study there were two hypothesis:  
Can scorpions detect predators?  
$H_0:$ put null here  
$H_A:$ put the alternative here.  

Is there evidence that the 'name of hairs on pincher' assist in detection of a predator?      
$H_0:$ put null here      
$H_A:$ put alternative here      
...
```{r}
a=data.frame(scorps[scorps$group=='untreated',])
a
b=table(a$Odor.location,a$Arm.selected)  
barchartGC(b)  
```
